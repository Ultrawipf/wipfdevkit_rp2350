...
# INFO: Disables probe param. Must replace with original
...
class MMA8451:
    ...
    **Quickstart: Importing and using the device**
    ...
    def __init__(self, i2c: I2C, *, address: int = _MMA8451_DEFAULT_ADDRESS) -> None:
        #self._device = i2c_device.I2CDevice(i2c, address,False)
        # Verify device ID.
        self.i2c = i2c
        self.addr = address
        # self.i2c.try_lock()
    ...
    def _write_u8(self, address: int, val: int) -> None:
        # Write an 8-bit unsigned value to the specified 8-bit address.ä
        while not self.i2c.try_lock():
            pass
        #with self._device as i2c:
